...
(
    K_IDTX integer NOT NULL,
	K_IDCUENTA integer NOT NULL,
	F_DIA numeric(2) NOT NULL,
	F_MES numeric(2) NOT NULL,
	F_ANNO numeric(4) NOT NULL,
...
ALTER TABLE Cuenta ALTER COLUMN K_IDCUENTA SET DEFAULT nextval('Cuenta_K_IDCUENTA_seq')
;
...
ALTER TABLE Transaccion ALTER COLUMN K_IDTX SET DEFAULT nextval('Transaccion_K_IDTX_seq')
;
...
ALTER SEQUENCE cuenta_k_idcuenta_seq OWNED BY  Cuenta.K_IDCUENTA
;

ALTER SEQUENCE Transaccion_K_IDTX_seq OWNED BY  Transaccion.K_IDTX
;